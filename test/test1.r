...
data = data.frame(x0=x0, ysim = ysim, yhat = yhat, ylin=ylin)
write.csv(format(data, digits=5), "output/test1.csv", 
          row.names=FALSE, quote=FALSE)

capture.output(summary(obj), file = "output/test1_summary.txt")
